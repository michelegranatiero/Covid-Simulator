public class General {
    ...
    //Aspetti sanitari
    static double infectivity = 0.1;  //probabilità (maggiore di 0) che un individuo sano venga infettato a seguito di un incontro con un contagiato asintomatico o sintomatico;
    ...
    static int recoveryTime = 50;    //numero giorni trascorsi tra contagio e guarigione, DURATA DEL VIRUS
